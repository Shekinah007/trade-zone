          ...
          {[
            {
              ...
              desc: "Post your item and reach thousands of buyers instantly.",
            },
            {
              icon: ShieldCheck,
              title: "Safe & verified",
              desc: "Our approval system ensures only trusted sellers operate.",
            },
            {
              icon: Globe,
              title: "Local community",
              desc: "Connect with buyers and sellers near you.",
            },
                    ...
                    {password.length > 0 && (
                      <div className="flex gap-3 mt-1 flex-wrap">
                        {strength.map(({ label, met }) => (
                          <span
                            key={label}
                            className={`text-xs flex items-center gap-1 ${met ? "text-green-500" : "text-muted-foreground"}`}
                          >
                            <span
                              className={`h-1.5 w-1.5 rounded-full ${met ? "bg-green-500" : "bg-muted-foreground"}`}
                            />
                            {label}
                          </span>
                        ))}
