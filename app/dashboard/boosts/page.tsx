...
//                       </div>
//                       <div
//                         className={`h-5 w-5 rounded border flex items-center justify-center ${selectedListings.includes(listing._id) ? "bg-amber-500 border-amber-500 text-white" : "border-gray-300"}`}
//                       >
