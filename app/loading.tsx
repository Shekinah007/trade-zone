  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute h-6 w-6 rounded-full bg-linear-to-br from-green-500 to-red-500 shadow-lg" />
      </div>
      ...
      {/* Bottom Glow */}
      <div className="absolute bottom-0 left-0 h-40 w-full bg-linear-to-t from-green-50 via-red-50 to-transparent" />
    </div>
  );
}
