...
export function ListingActions({
  ...
  sellerPhone,
}: ListingActionsProps & { status?: string }) {
        ...
        <div className="mt-6 pt-6 border-t">
          ...
          <div className="space-y-4">
            {history.map((tx: any) => (
              <div
                key={tx._id}
                className="flex items-center text-sm border p-3 rounded-lg bg-muted/20"
              >
                <div className="flex-1">
                  <p className="font-medium">
                    Purchased by {tx.buyer?.name || "User"}
                  </p>
                  <p className="text-xs text-muted-foreground">
        ...
        <AlertDialogContent>
          ...
          <div className="space-y-4 my-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                If they have a FindMaster account, we'll notify them to accept
                the property transfer or secure it.
              </p>
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium">
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          variant="ghost"
          className="w-full text-muted-foreground h-auto p-0 hover:text-destructive justify-start"
        >
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Please describe why you are reporting this listing. Our team will
            review it shortly.
          </DialogDescription>
        </DialogHeader>
        <Textarea
